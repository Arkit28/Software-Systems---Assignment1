...
We first outlined the major components of the shell and assigned each section to one team member. The responsibilities were divided as follows:
...
This structure allowed us to work in parallel while avoiding conflicts. 
